...
public class CartController {
    ...
    public void addToCart(int productId, int quantity) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error fetching product: " + ex.getMessage(), "Cart Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (product == null) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error adding item to cart: " + ex.getMessage(), "Cart Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void removeFromCart(int productId) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error removing item from cart: " + ex.getMessage(), "Cart Error", JOptionPane.ERROR_MESSAGE);
        }
        if (this.cartView != null && this.cartView.isVisible()) {
            loadCartForView(this.cartView);
        }
    ...
    public void updateCartQuantity(int productId, int newQuantity) {
        ...
        try {
            if (cartDao.updateCartItemQuantity(currentUser.getUserId(), productId, newQuantity)) {
                ...
                JOptionPane.showMessageDialog(null, "Failed to update cart item. Check stock or database connection.", "Cart Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Error updating cart item: " + ex.getMessage(), "Cart Error", JOptionPane.ERROR_MESSAGE);
        }
        if (this.cartView != null && this.cartView.isVisible()) {
            loadCartForView(this.cartView);
        }
    ...
    public void checkout() {
        ...
        try {
            cartItems = cartDao.getCartItemsByUserId(currentUser.getUserId());
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Error fetching cart items: " + ex.getMessage(), "Checkout Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        for (CartItem item : cartItems) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Error fetching product: " + ex.getMessage(), "Checkout Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
